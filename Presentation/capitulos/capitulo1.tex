...
\note{
Dichos exámenes generan múltiples planos anatómicos 2D del cuerpo que luego se representan en 3D.
Y es evidente, que las distorsiones que sufren en 2D afectan al modelo 3D reconstruido.

Por otro lado, habitualmente, la adquisición de 
...
No obstante, el número de métodos propuestos para la estimación de calidad decrece 
al desplazarnos a tres dimensiones. Más aún si se trata del ámbito biomédico. 
}
...
\item Estudiar los patrones de distorsión que afectan a las imágenes biomédicas.
