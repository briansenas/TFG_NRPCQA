...
\begin{figure}[htp]
  ...
  \end{center}
  \caption[Visualización del hiperplano MSE de imágenes distorsionadas.]{En este ejemplo, extraído de\cite{Wang2006ModernIQ}, la misma imagen distorsionada de distintas maneras resulta en el mismo valor MSE\footnotemark[3]=181. Siendo evidente que 
...
A través de algoritmos y modelos, las máquinas pueden reconocer patrones, hacer predicciones y tomar decisiones basadas en información proporcionada.
...
\subsection{Ensemble o Conjunto \emph{Deep Learning}}
