...
Con las 5 distorsiones aplicadas a 7 niveles de intensidad sobre los 11 modelos obtenemos 385 ejemplos en total. 
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{Ejemplo detallado de las etapas del método de VQA-PC\cite{VQA-PC}.}
