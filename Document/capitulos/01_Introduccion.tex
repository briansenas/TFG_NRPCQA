...
\corrected[{Respuesta a Enrique, :nlazar con la reconstrucción de modelos y regiones anatómicas}]
{
...
\changed[{En respuesta a Enrique, cambios de todos los objetivos}]{Se generaliza los objetivos}
\begin{enumerate}
