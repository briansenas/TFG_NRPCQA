...
así como también facilita la planificación quirúrgica y entre otros~\cite{3DImagingInMedicine, 3DImagingInMedicine2, ADAS3D}.
...
prevaleciendo las distorsiones de contraste, ruido y difuminado\footnote{
  Con \emph{ruido} nos referimos a pequeñas fluctuaciones no deseadas en los colores de 
  los píxeles debido a interferencias de todo tipo. \emph{Difuminado} se refiere a la 
...
las imágenes médicas, afectando el análisis y dianóstico asociados Por ejemplo, 
...
\begin{enumerate}
  \item Realizar una revisión exhaustiva del estado del arte para la estimación de calidad 
    de imágenes \emph{3D}, así como de la calidad de imágenes médicas 3D en particular.
